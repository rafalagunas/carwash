    ...
    <div className="main">
      ...
      <div className="row__possession">
        <div className="title__possession">
          <p>
            Todos nuestros productos son específicamente para cada parte de tu
            vehículo, por lo que recibirás un tratamiento especial y de calidad
            asegurada.
            <br /> No usamos productos comunes o convencionales como en
            cualquier lavacoches, nosotros queremos asegurar la calidad de
            nuestro servicio. <br />
            <br />
            Si vas a un lugar en donde le ponen ArmorAll a tus plásticos, no
            cuidan tu coche.
          </p>
        </div>
      </div>
      ...
      <div className="row__three">
        ...
        <div className="services__carwash"></div>
      </div>
      <div className="row__possession">
        <div className="title__possession">
          <p>
