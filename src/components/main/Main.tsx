    ...
    <div className='main'>
      ...
      <div className='row__two'>
        <div className='our__title_container'>
            <p>
                <span className='our__title'>Somos un autolavado</span> 
                sit amet consectetur adipisicing elit. Maiores, nobis! Maiores accusantium nihil nulla, corporis placeat quidem, et excepturi
            </p>
        </div>
      ...
      <div className='row__three'>
            ...
            <div className='services__carwash'>
                <div className='card'>
                    <div className='img__services_carwash_one'>
                      
                    </div>
                   <div className='card__content'>
                        <div className='type__service'>
                            <p>Servicios Básico</p>
                        </div>
                ...
                <div className='card'>
                    <div className='img__services_carwash_two'>
                ...
                <div className='card'>
                    <div className='img__services_carwash_three'>
